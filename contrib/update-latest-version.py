...
try:
    imp.load_module('electrum_vestx', *imp.find_module('../electrum_vestx'))
    from electrum_vestx import constants, keystore, storage, SimpleConfig
    from electrum_vestx.version import ELECTRUM_VERSION
    from electrum_vestx.gui.qt import update_checker
    from electrum_vestx.plugin import Plugins
...
CONFIG_NAME = '.update-last-version-vestx-electrum'
