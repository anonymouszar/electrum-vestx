#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Search and replaces BTC addresses and private keys in WIF to VESTX variant"""
...
from electrum_vestx.bitcoin import (b58_address_to_hash160, hash160_to_b58_address,
                         serialize_privkey, DecodeBase58Check, WIF_SCRIPT_TYPES)
from electrum_vestx.util import inv_dict
