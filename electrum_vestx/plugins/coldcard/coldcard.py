...
from electrum_vestx.bip32 import BIP32Node, InvalidMasterKeyVersionBytes
from electrum_vestx.i18n import _
from electrum_vestx.plugin import Device
from electrum_vestx.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
from electrum_vestx.transaction import Transaction
from electrum_vestx.wallet import Standard_Wallet
from electrum_vestx.crypto import hash_160
from electrum_vestx.util import bfh, bh2u, versiontuple, UserFacingException
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            # - customized to use specific EC library of Vestx-Electrum.
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def _encode_txin_type(txin_type):
        # Map from electrum_vestx code names to our code numbers.
