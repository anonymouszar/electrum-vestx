...
from electrum_vestx.crypto import aes_encrypt_with_iv, aes_decrypt_with_iv
from electrum_vestx.i18n import _
from electrum_vestx.util import log_exceptions, ignore_exceptions, make_aiohttp_session
...
class LabelsPlugin(BasePlugin):
    ...
    def __init__(self, parent, config, name):
        ...
        self.target_host = 'labels.electrum_vestx.org'
        self.wallets = {}
