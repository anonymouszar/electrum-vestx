...
from electrum_vestx.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_vestx.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                              is_address)
from electrum_vestx.bip32 import BIP32Node
from electrum_vestx import ecc
from electrum_vestx.ecc import msg_magic
from electrum_vestx.wallet import Standard_Wallet
from electrum_vestx import constants
from electrum_vestx.transaction import Transaction
from electrum_vestx.i18n import _
from electrum_vestx.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from electrum_vestx.util import to_string, UserCancelled, UserFacingException
from electrum_vestx.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def check_device_dialog(self):
        ...
        if not self.setupRunning:
            self.isInitialized = True # Wallet exists. Vestx-Electrum code later checks if the device matches the wallet
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Vestx-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
