...
from electrum_vestx.masternode import MasternodeAnnounce, MasternodePing, NetworkAddress
from electrum_vestx.masternode_manager import parse_masternode_conf, MasternodeConfLine
from electrum_vestx import bitcoin
from electrum_vestx.crypto import sha256d
from electrum_vestx import ecc
from electrum_vestx.util import bfh, to_bytes
...
raw_announce = ''
...
class TestMasternode(unittest.TestCase):
    def test_serialization(self):
        ...
        self.assertEqual('e23d7d08e8a5b72313f2b0cd9f5ff14647f3055538c4761d4e928662670ad5f3', announce.vin['prevout_hash'])
        ...
        self.assertEqual('45.32.125.85:20000', str(announce.addr))

        self.assertEqual('039c8cef4a10b7246796563b4ae7614aaafcd61550b38acc296085dc1e942f52bc', announce.collateral_key)
        self.assertEqual('0446eac61b70401b6ccf63d4bacf16991180c2b9cc25138fa710da62449659ca0b1ce362931b951e87c818170e927a422992a3dd32aad321e9b6d91430a4ffaf87', announce.delegate_key)
        ...
        self.assertEqual(1563376416, announce.sig_time)
        self.assertEqual(70214, announce.protocol_version)

        #self.assertEqual('e23d7d08e8a5b72313f2b0cd9f5ff14647f3055538c4761d4e928662670ad5f3', announce.last_ping.vin['prevout_hash'])
        ...
        #self.assertEqual('1791b63bba79ad9211f6aca8d7dfa2aee7ca1ee7e11942e6f687a53ca42e72e8', announce.last_ping.block_hash)
...
class TestMasternode70210(unittest.TestCase):
    ...
    def test_serialize_protocol_version_70210(self):
        ...
        expected = to_bytes(''.join([
            '45.32.125.85:20000',
            '1563376416',
            bitcoin.hash_encode(bitcoin.hash_160(bfh('039c8cef4a10b7246796563b4ae7614aaafcd61550b38acc296085dc1e942f52bc'))),
            bitcoin.hash_encode(bitcoin.hash_160(bfh('0446eac61b70401b6ccf63d4bacf16991180c2b9cc25138fa710da62449659ca0b1ce362931b951e87c818170e927a422992a3dd32aad321e9b6d91430a4ffaf87'))),
            '70214',
        ]))
        print('7'*50, expected)
        print('8'*50, msg)
    ...
    def test_create_and_sign(self):
        collateral_pub = '039c8cef4a10b7246796563b4ae7614aaafcd61550b38acc296085dc1e942f52bc' # XahPxwmCuKjPq69hzVxP18V1eASwDWbUrn
        delegate_pub = '02526201c87c1b4630aabbd04572eec3e2545e442503e57e60880fafcc1f684dbc' # Xx2nSdhaT7c9SREKBPAgzpkhu518XFgkgh
