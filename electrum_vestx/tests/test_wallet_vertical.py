...
from electrum_vestx import storage, bitcoin, keystore, bip32
from electrum_vestx import Transaction
from electrum_vestx import SimpleConfig
...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_multisig_seed_standard(self, mock_write):
        ...
        # electrum_vestx seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        # electrum_vestx seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
