...
class MasternodeManager(object):
    ...
    def get_masternode_outputs(self, domain = None, exclude_frozen = True):
        ...
        # Valid outputs have a value of exactly 15000000 VESTX and
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 15000000:
            raise Exception('Masternode requires a collateral 15000000 VESTX output.')
    ...
    def send_announce(self, alias):
        ...
        res = self.wallet.network.run_from_another_thread(self.wallet.network.masternode_announce_broadcast(mn))
