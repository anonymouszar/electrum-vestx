...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.vestx.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.vestx.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.vestx.electrum:externalType",
                '',
                data)
        return extRecord
