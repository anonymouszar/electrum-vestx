...
from electrum_vestx.bitcoin import COIN
from electrum_vestx.i18n import _
from electrum_vestx.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 15000000 VESTX output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 15000000 VESTX output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 15000000 VESTX was sent to'))
...
class MasternodeEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        form.addRow(_('Collateral vestx Output:'), self.vin_edit)
...
class MasternodeOutputsTab(QWidget):
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 15000000 VESTX outputs were found.'))
