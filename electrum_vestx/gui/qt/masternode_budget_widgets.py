...
from electrum_vestx.masternode_budget import BudgetProposal, BudgetVote
from electrum_vestx.masternode_manager import BUDGET_FEE_CONFIRMATIONS
from electrum_vestx.util import block_explorer_URL, format_satoshis_plain
...
def budget_explorer_url(item_type, identifier):
    ...
    if item_type == 'proposal':
        return 'https://vestxwhale.org/p/%s' % identifier
...
class ProposalsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        description = ''.join(['You can create a budget proposal below. ',
                'Proposals require 5 VESTX to create. ',
