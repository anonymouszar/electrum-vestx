...
from electrum_vestx.util import UserCancelled, InvalidPassword, WalletFileException
from electrum_vestx.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.setWindowTitle('Vestx-Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-vestx.png')
        self.show()
        self.raise_()
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('Vestx-Electrum wallet'))
